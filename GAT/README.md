# GATpython dgl_gat_main.py --num_epochs=2500 --hidden_dims=64 --heads=4 --dropout=0.2 --loss_mul=1 --sample_filename=/home/njucm/下载/CPDB_multiomics_samsplit_黄芪.h5 --lr=0.001 --seed=1 --cuda
